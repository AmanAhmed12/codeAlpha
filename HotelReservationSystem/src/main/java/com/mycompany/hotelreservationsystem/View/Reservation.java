...
package com.mycompany.hotelreservationsystem.View;

import com.mycompany.hotelreservationsystem.Model.ReservationSystem;
...
public class Reservation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        roomNumberField.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N

        searchButton.setBackground(new java.awt.Color(0, 102, 102));
        searchButton.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        searchButton.setText("Search");
        searchButton.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 3));
        ...
        reserveButton.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 3));
        ...
        resultArea.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        resultArea.setRows(5);
        resultArea.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.LOWERED, new java.awt.Color(0, 102, 102), new java.awt.Color(0, 102, 102), new java.awt.Color(0, 102, 102), new java.awt.Color(0, 102, 102)));
        jScrollPane1.setViewportView(resultArea);

        categoryField.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        categoryField.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "standard", "suite" }));
        ...
        btnQuit.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 3));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(categoryField, 0, 221, Short.MAX_VALUE))
                        .addGap(56, 56, 56))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addGap(49, 49, 49)
                                .addComponent(btnQuit, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(35, 35, 35)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(reserveButton, javax.swing.GroupLayout.DEFAULT_SIZE, 127, Short.MAX_VALUE)
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        if (category.equals("Select") || roomNo.equals("")) {
            JOptionPane.showMessageDialog(this, "Fileds cannot be Empty !!!");
        } else {
            try {

                List<Room> availableRooms = reservationSystem.searchAvailableRooms(category);
                StringBuilder result = new StringBuilder();
                result.append("Available Rooms:\n");
                for (Room room : availableRooms) {
                    result.append("Room Number: ").append(room.getRoomNumber())
                            .append(", Category: ").append(room.getCategory())
                            .append("\n");
                }
    ...
    private void reserveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_reserveButtonActionPerformed
        ...
        if (category.equals("Select") || roomNo.equals("")) {
            ...
            try {
                ...
                boolean reserved = reservationSystem.makeReservation(roomNumber);
                if (reserved) {
                    Room room = reservationSystem.getRoom(roomNumber);
                    JOptionPane.showMessageDialog(this, "Room " + roomNumber + " reserved successfully!");
                } else {
                    JOptionPane.showMessageDialog(this, "Room " + roomNumber + " is not available.");
                }
    ...
    private void btnQuitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQuitActionPerformed
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            for (Window window : Window.getWindows()) {
                if (window instanceof Reservation) {
                    ((Reservation) window).dispose();
                }
            }
        }
